class ScrollManager {
  ...
  scrollToNextSection(easing) {
      if (this.currentSection < this.sections.length - 1) {
          ...
          const targetOffset = this.scrollDirection === 'vertical'
  ...
  animateScroll(targetOffset, easing) {
    ...
    const startOffset = this.scrollDirection === 'vertical'
        ? window.pageYOffset
        : window.pageXOffset;
...
const verticalScrollManager = new ScrollManager('.vertical-scroll-container', 'vertical');
const horizontalScrollManager = new ScrollManager('.horizontal-scroll-container', 'horizontal');