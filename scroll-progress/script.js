document.addEventListener("DOMContentLoaded", function () {
  ...
  wrappers.forEach(function (wrapper) {
    var instanceNumber = wrapper
      .getAttribute("ct-scroll-progress")
      .replace("wrapper", "");
    var wrapperSelector = document.querySelector(
      '[ct-scroll-progress="wrapper' + instanceNumber + '"]',
    );
    var timeDivSelector = document.querySelector(
      '[ct-scroll-progress="line' + instanceNumber + '"]',
    );
    var numberSelector = document.querySelector(
      '[ct-scroll-progress="number' + instanceNumber + '"]',
    );
